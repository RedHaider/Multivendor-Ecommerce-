...
from .views import dashboard, product_management,sales_performance,promotion_discount,commission,registration, login , add_vendor, commission_form, commission_details, coupon_form,   coupon_edit ,commission_edit ,vendor_edit
